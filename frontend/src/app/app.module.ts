...
import { AppMainComponent, UrlConstants } from './app.main.component';
...
@NgModule({
    ...
    declarations: [
        ...
        DuvidasComponent,
        ValidarApoliceComponent,
        AprovarApoliceComponent,
    ],
    providers: [
        {provide: LocationStrategy, useClass: HashLocationStrategy},
        {provide: HTTP_INTERCEPTORS, useClass: HttpInterceptorInterceptor, multi: true},
        CountryService, CustomerService, EventService, IconService, NodeService,
        PhotoService, ProductService, MenuService, ConfigService, AuthService,DatePipe
    ],
